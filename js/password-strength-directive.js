        ...
        return {
            ...
            link: function ($scope, $element, $attrs, $ctrl) {
                ...
                $scope.onPasswordChange = function (password) {
                    ...
                    if (password.value) {
                        password.rules.hasNumber = password.value.match(/\d/) ? true : false;
                        password.rules.hasLetter = password.value.match(/[A-z]/) ? true : false;
                        password.rules.isValidLength = password.value.match(/^.{6,}$/) ? true : false;
                        password.rules.noSpecialChar = !password.value.match(/[ \/"]/) ? true : false;
                    }
